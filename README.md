...
```
    if (!ECAR.DocuSign.DocuSignConfig.Ready)
    {
        ...
        ECAR.DocuSign.DocuSignConfig.RSAKey = "«Content of your DocuSign RSA KeyFile»";
    }
...
```
    DocumentModel dsDoc = new DocumentModel
    {
        ...
        SignerId = "«Your application's tracking ID for this recipient»"       // DocuSign does not use this field
    };
```
...
- Your application may need to save this information to retrieve information from this document
...
- Supports only full screen embedded ceremony.  Does not support emailing.
